                            ...
                            <div class="col-xl-1 col-lg-2 col-md-3 col-sm-4 col-6 mb-3 text-center">
                                <a href=""
                                    ...
                                    <img src="{{ asset('assets/img/icons/icons-short.png') }}" alt="" width="80"
                                        height="80">
                                    <span class="fs-5 mt-2 fw-bold text-dark">Users</span>
                                </a>
                            </div>
                            <div class="col-xl-1 col-lg-2 col-md-3 col-sm-4 col-6 mb-3 text-center">
                                <a href=""
                                    ...
                                    <img src="{{ asset('assets/img/icons/icons-short.png') }}" alt="" width="80"
                                        height="80">
                                    <span class="fs-5 mt-2 fw-bold text-dark">Cases</span>
                                </a>
                            </div>
                            <div class="col-xl-1 col-lg-2 col-md-3 col-sm-4 col-6 mb-3 text-center">
                                <a href=""
                                    ...
                                    <img src="{{ asset('assets/img/icons/icons-short.png') }}" alt="" width="80"
                                        height="80">
                                    <span class="fs-5 mt-2 fw-bold text-dark">Schedules</span>
                                </a>
                            </div>
                              <div class="col-xl-1 col-lg-2 col-md-3 col-sm-4 col-6 mb-3 text-center">
                                <a href=""
