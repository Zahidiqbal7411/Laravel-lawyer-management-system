                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Add New Services</h5>
										...
										<button type="button" class="btn btn-light" id="sweet_success">Launch <i class="icon-play3 ml-2"></i></button>

                    <div class="card-body border-top">
                        <form action="{{ route(getPrefix() .'roles.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="text-end">
                                <button type="submit" class="btn btn-primary">
                                    Submit Role <i class="ph-paper-plane-tilt ms-2"></i>
                                </button>
                            </div>
                        </form>
